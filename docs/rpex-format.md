...
我们不妨定义 (行为以 `Python 3.12.7 (tags/v3.12.7:0b05ead, Oct 1 2024, 03:06:41)` 为准):
...
class Beat:
    ...
    def __eq__(self, other: object):
        return self.value == other.value if isintance(other, type(self)) else NotImplemented
...
class EasingDefinitionItem:
    ...
    _pyFunction: typing.Callable[[float], float]|None = None
